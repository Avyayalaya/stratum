      ...
      html += `
        <div style="margin-bottom:10px;">
          <div style="display:flex;justify-content:space-between;align-items:baseline;">
            <span style="font-size:14px;color:#111827;font-weight:500;">${s.skill}</span>
          </div>
...
<div style="max-width:760px;margin:0 auto;padding:40px 24px;">
  ...
  <div style="margin-top:36px;padding-top:20px;border-top:1px solid #E5E7EB;display:flex;justify-content:space-between;align-items:center;">
    <span style="font-size:12px;color:#9CA3AF;">Generated by <strong>Stratum</strong> &mdash; the behavioral meta-skill framework</span>
