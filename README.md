...
Fifteen behavioral meta-skills across three domains — Cognitive Mastery, Character Core, Trust Dynamics. Assessed through behavioral evidence (what people do under pressure), weighted by function and level (a PM and an engineer with the same raw scores get different gap priorities), then turned into role-weighted development priorities and team-composition diagnostics.
...
- **[Sample Reports](./reports/)** — output design reference; illustrative samples generated by the CLI
- **[Case Studies](./cases/)** — teams run through Stratum; an illustrative walk-through is available (validated cases with outcome data still to come)
